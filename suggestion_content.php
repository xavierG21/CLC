...
<div class="photoframe f_left shadow wrapper m_right_30 m_sm_bottom_5 m_sm_right_20 m_xs_bottom_15 f_xs_none d_xs_inline_b" >
						<img class="tr_all_long_hover" src="photo/'.$image.'" alt="" width="300px" height="300px">
					</div>
					<div class="r_corners m_bottom_30" style="background-color: white;padding:30px;">
									<h2>Description: </h2><br>
									<p class="m_bottom_10">'.$desc.'</p>
					</div>
