<?php
		...
		if(isset($_GET['pro_id'])){
			...
			$query  = "SELECT * FROM products p inner JOIN product_details pd on p.product_id = pd.product_id WHERE pd.id = '$prod_id' ";
							//echo $query;
				...
				<div class='clearfix'>
					<div class='custom_scrollbar'>
						...
						<div class='f_right half_column'>
							<!--description-->
							<h2 class=;m_bottom_10;><a href='#' class=;color_dark fw_medium;>".$row['product_name']."</a></h2>
