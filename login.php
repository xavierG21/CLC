                  ...
                  <form  method ="POST" action="doLogin.php">
                     <ul>
                        <li class="m_bottom_10">
                           ...
                           <input type="text" name="username" id="username" class="r_corners half_width form-control" >
                        </li>
                        <li class="m_bottom_25">
                           <label for="password" class="m_bottom_5 d_inline_b">Password</label>
                           <input type="password" name="password" id="password" class="r_corners half_width form-control">
                        </li>
                        
                        <li class="clearfix m_bottom_30">

                           <div class="f_center f_size_medium f_mxs_none">
                              <a href="forget_pass.php" class="color_dark">Forgot your password?</a><br>
