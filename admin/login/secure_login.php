...
$pass_key2 = md5($_POST['pass_key']);
$pass_key     = substr($pass_key2,0,30);
...
$pass_key3     = mysqli_real_escape_string($con, $pass_key);
//$pass_key     = substr($pass_key2,0,30);
...
if ($count == 1) {
    ...
    if ($auth_l_x == 5) {
        ...
        header("location: ../dashboard/deliver/");
    } else if ($auth_l_x == 3) {
