...
<head>
    ...
    <body class="page-body  page-fade">
		...
		<div class="sidebar-menu">
			...
			<div class="logo">
				<a href="main.php">
					<img src="../../img/sx.png" alt="" width="192" height="80" />
				</a>
			</div>
			...
			<thead>
				...
				<tbody>
						...
						<?php
							...
							$query  = "select * from registration ORDER BY birthday DESC";
							//echo $query;
							$result = mysqli_query($con, $query);
									$msgid   =['member_code'];
							            ...
							            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
											...
											$sno++;
											$msgid = $row['member_code'] ;
											$msgid1 = $row['name'] ;
											$msgid2 = $row['customer_id'] ;
											...
											//</form><form action='del_member.php' method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Delete ' class='btn btn-danger'/></form></td></tr>";
							                 echo "<td><form action='new_reg_table.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='hidden' name='full_name' value='" . $msgid. "'/><input type='submit' value='Log in' class='btn btn-info'/></form><form action='view_reg_table.php' method='post'><input type='hidden' name='name' value='" . $msgid2 . "'/><input type='hidden' name='full_name' value='" . $msgid1. "'/><input type='submit' value='Log in History' class='btn btn-warning'/></form></td></tr>";
