							...
							$result = mysqli_query($con, $query);
							        ...
							        //if (mysqli_affected_rows($con) == 0) {
							            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
											...
											echo "<td><img src='../../../photo/".$row['color_one']."'  alt='' height='200px' width='200px'></td>";

											echo "<td><img src='../../../photo/".$row['color_two']."'  alt='' height='200px' width='200px'></td>";

											echo "<td><img src='../../../photo/".$row['color_three']."'  alt='' height='200px' width='200px'></td>";
											...
											//</form><form action='del_member.php' method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Delete ' class='btn btn-danger'/></form></td></tr>";
							                 ...
							                 <a href='image_product_edit.php?id=".$msgid."' class='btn btn-info' >Change Images</a></div>
