		...
		<table class="table table-bordered datatable" id="table-1">
			<thead>
				...
				<tbody>
						...
						<?php
							$query="SELECT * from suggestion_material WHERE suggestion_id ='$memid' ";
							        ...
							        //if (mysqli_affected_rows($con) == 0) {
							            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
											...
											//</form><form action='del_member.php' method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Delete ' class='btn btn-danger'/></form></td></tr>";
							                 echo "<td>
							                  <form action='register_materials_delete.php' method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Delete ' class='btn btn-danger'/></form></td></tr>";
