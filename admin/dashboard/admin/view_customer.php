						...
						<?php
							...
							$result = mysqli_query($con, $query);
							            ...
							            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							                ...
							                $msgid = $row['customer_id'];
							                
							             
							                //echo "<td><a href='edit_reg.php?pid=".$row['member_code']."'>EDIT</a></td>";
							                echo "<td>
											
											<form action='# method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid. "'/><input type='submit' value='Delete ' class='btn btn-danger'/></form>
											</td></tr>";
