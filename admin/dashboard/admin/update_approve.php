...
$comment = "Admin approved your order";
	if (isset($_POST['name3'])) 
	 {
			...
			date_default_timezone_set('Asia/Manila');
            $day = date("Y-m-d h:i:sa");
            $say = "Dear beloved customer as of " .$day. " your order has been approved thank you ";
            //echo $say;
			...
			mysqli_query($con, "UPDATE orders SET status='$update',admin_comment='$comment',approvedDate='$day' WHERE orderNumber='$ordNum'");
