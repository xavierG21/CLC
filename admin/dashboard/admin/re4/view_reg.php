			...
			<thead>
				...
				<tbody>
						...
						<?php
							...
							$query  = "select id,member_code,name,age,birthday,gender,weight,height,email,address,contactNo from registration";
							//echo $query;
								...
								if(!$result){
							            ...
							            while ($row = mysqli_fetch_array($result)) {
							              ...
							              echo "<td>" . $row['customer_id'] . "</td>";
											...
											echo "<td>" . $row['name'] . " </td>";
											echo "<td>" . $row['age'] . " / " . $row['birthday'] . "</td>";
							                echo "<td>" . $row['gender'] . "</td>";
							                echo "<td>" . $row['weight'] . " / " . $row['height'] . " </td>";
							                echo "<td>" . $row['email'] . " / " . $row['address'] . "</td>";
							                echo "<td>" . $row['contactNo'] . " </td>";
							                
							             
							                echo "<td><a href='edit_product.php?pid=".$row['member_code']."'>EDIT</a></td>";
