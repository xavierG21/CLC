						...
						<?php
							...
							$result = mysqli_query($con, $query);
							            ...
							            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
											...
											<form action='del_walkin.php' method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid. "'/><input type='submit' value='Pending..' class='btn btn-danger'/></form>
											</td></tr>";
