			...
			<thead>
				...
				<tbody>
						...
						$date=date('Y-m-d');
							...
							$query = "SELECT registration.name as mname, walkin.name as wname,date, timein, registration.customer_type AS mc,walkin.customer_type AS wc FROM login_data	
							LEFT JOIN registration ON login_data.customer_id = registration.customer_id 
							LEFT JOIN walkin ON login_data.customer_id = walkin.`customer_id`";

							$result = mysqli_query($con, $query);

							while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							                
							                if($row['mname']!=NULL AND $row['date']== $date){
											echo "<tr><td>". $row['mname'] .  " </td>";
							              
							                echo "<td>" . $row['mc'] . "</td>";
							                echo "<td>" . $row['date'] . "</td>";
											echo "<td>" . $row['timein'] . " </td> </tr>";
										}
										else{
											echo "<tr><td>". $row['wname'] .  " </td>";
							                echo "<td>" . $row['wc'] . "</td>" ;
							                echo "<td>" . $row['date'] . "</td>";
							                echo "<td>" . $row['timein'] . " </td> </tr>";
							            }
