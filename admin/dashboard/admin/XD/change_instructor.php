				...
				<tbody>
					...
					$sno    = 1;
					    ...
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        echo "<td><form action='edit_instructor.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Edit Instructor ' class='btn btn-info'/></form><form action='del_instructor.php' method='post' onSubmit='return ConfirmDelete();'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Delete instructor' class='btn btn-danger'/></form></td></tr>";
