...
<head>
    ...
    <body class="page-body  page-fade">
		...
		<form action="register_materials_insert.php" method="POST" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
		
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Suggestion ID</label>					
					<div class="col-sm-5">
						<input type="text" name="s_id" value ='<?php echo $memid; ?>' class="form-control"  readonly/>
					</div>
			</div>

			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Material Name</label>					
					<div class="col-sm-5">
						<input type="text" name="m_name" id="textfield5" class="form-control" data-rule-required="true" data-rule-minlength="6" placeholder="Product Name">
					</div>
			</div>
