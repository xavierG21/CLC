			...
			<thead>
				...
				<tbody>
						...
						<?php
							...
							$query  = "SELECT * FROM `payments` p INNER join orders o ON p.orderNumber = o.orderNumber INNER JOIN customers c ON p.user_id = c.user_id";
							//echo $query;
							$result = mysqli_query($con, $query);
							            ...
							            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
											...
											echo "<td>" . $row['fname'] . " " . $row['lname'] . " <br>" . $row['contact_no'] . "<br>".$row['address']."  </td>";
											
											//echo "<td>" . $row['status'] . " </td>";
											if($row['code'] != 'Paypal'){
												echo "<td><img src=../../../photo/" . $row['code'] . " width='50px' height='50px'><br><br>
												<div align='right'><a href='code_verify.php?id=".$row['code']."' class='btn btn-primary' id='modal_me'>Verify Payment</a></div>
												...
												echo "<td align='center'><img src='../../../images/paypal_logo.png' width='50px' height='50px'></td>";
											}
											...
											<font color='blue'><p><em>APPROVED</em></p></font>
