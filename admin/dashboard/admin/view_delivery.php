			...
			<thead>
				...
				<tbody>
						...
						<?php
							...
							$query  = "select * from orders o inner join customers c on o.customerID = c.user_id WHERE o.status = 'Delivered' AND o.method = 'delivery' ";
							//echo $query;
							$result = mysqli_query($con, $query);
							            ...
							            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
											...
											echo "<td align='center'><h4 class='text-danger'><em>" . $row['status'] . " </em></h4></td>";
											
							                
											
											
											
							               	 	$msgid = $row['customerID'];
