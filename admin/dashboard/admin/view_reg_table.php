...
<head>
    ...
    <body class="page-body  page-fade">
		...
		<h3>Member Login Details for  :- <?php $mem_id = $_POST['name']; echo $_POST['full_name']; ?></h3>
		...
		<table class="table table-bordered datatable" id="table-1">
			<thead>
				...
				<?php
					$query = "SELECT instructor.name,date,timein FROM `login_data` LEFT JOIN instructor On login_data.instructor_id = instructor.id WHERE customer_id ='$mem_id' ORDER BY date DESC";
					//$query  = "select * from login_data WHERE customer_id ='$mem_id' ORDER BY date DESC";
					//echo $query;
